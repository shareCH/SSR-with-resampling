context("test of main function of bootSS")
...
test_that("class of object is ssr", {
  actual <- of_design(control, treatment, design, delta,
                       beta_tilde, gamma, bootstrap = "t", B)
  expect_s3_class(actual, "ssr")
})


test_that("function calculates correct value", {
  set.seed(191111)
  actual <- of_design(control, treatment, design, delta,
                       beta_tilde, gamma, bootstrap = "t", B)
  ...
  actual <- of_design(control, treatment, design, delta,
                       beta_tilde, gamma, bootstrap = NULL, B)
  expected <- list("n" = 100, "n1" = 50, "n2" = 50,
                   "delta_obs" = .1195, "t1" = .5977,
                   "delta_ass" = delta,
                   "condPow" = .0725, "condPow_true" = .4782,
