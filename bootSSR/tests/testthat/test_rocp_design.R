context("test rocp main function of bootSSR")
...
test_that("class of object is ssr", {
  actual <- rocp_design(control, treatment, design, delta,
                        beta_0, bootstrap = NULL, B)
  expect_s3_class(actual, "ssr")
})


test_that("rocp function calculates correct value", {
  set.seed(191111)
  actual <- rocp_design(control, treatment, design, delta,
                        beta_0, bootstrap = "t", B)
